...
export default function Accordion({ question, answer, className, defaultOpen }: Props) {
  ...
  return (
    <div
      ...
      className="group rounded-base overflow-x-hidden border-2 border-border dark:border-darkBorder shadow-light dark:shadow-dark"
    >
      <button
        role="button"
        className={cn(
